...
1270 REM Test AND/OR logical operators
1280 LET TEST_AND = 0
1290 IF X > 5 AND X < 10 THEN LET TEST_AND = 1
1300 IF TEST_AND <> 1 THEN GOTO 9000
1310 LET TEST_OR = 0
1320 IF X = 7 OR X = 8 THEN LET TEST_OR = 1
1330 IF TEST_OR <> 1 THEN GOTO 9000
1340 PRINT "  PASS: IF/THEN/ELSE and logical operators"
1350 REM Test NOT logical operator
1360 LET TEST_NOT = 0
1370 IF NOT X > 10 THEN LET TEST_NOT = 1
1380 IF TEST_NOT <> 1 THEN GOTO 9000
1390 LET TEST_NOT_COMPLEX = 0
1400 IF NOT X > 10 AND X < 10 THEN LET TEST_NOT_COMPLEX = 1
1410 IF TEST_NOT_COMPLEX <> 1 THEN GOTO 9000
1420 PRINT "  PASS: NOT logical operator"
1430 REM
1440 REM TEST 9: GOSUB/RETURN
1450 REM
1460 PRINT "TEST 9: GOSUB/RETURN"
1470 LET RESULT = 0
1480 GOSUB 2000
1490 IF RESULT <> 42 THEN GOTO 9000
1500 PRINT "  PASS: GOSUB/RETURN subroutines"
1430 REM
1440 REM TEST 10: Nested Structures
1450 REM
1460 PRINT "TEST 10: Nested Structures"
