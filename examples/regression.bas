...
1130 REM
1140 PRINT "TEST 8: IF/THEN Statements"
1150 LET X = 7
1160 LET FLAG = 0
...
1210 PRINT "  PASS: IF/THEN conditions"
1220 REM
...
1490 REM Test ASC and CHR$ roundtrip
1500 LET FIRST_CHAR = ASC(LEFT$(TEST_STR$, 1))
1510 LET BACK_TO_CHAR$ = CHR$(FIRST_CHAR)
1520 IF LEN(BACK_TO_CHAR$) <> 1 THEN GOTO 9000
1530 REM Test VAL with numeric string
1540 LET NUM_PART$ = RIGHT$(TEST_STR$, 3)
1550 LET NUM_VAL = VAL(NUM_PART$)
1560 IF NUM_VAL <> 123 THEN GOTO 9000
1570 PRINT "  PASS: String function integration"
1580 REM
